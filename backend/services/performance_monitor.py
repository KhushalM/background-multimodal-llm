...
class PerformanceMonitor:
    ...
    def __init__(self, max_history: int = 1000):
        ...
        self.thresholds = {
            "stt": 3.0,        # STT should be under 3s
            "multimodal": 5.0,  # AI response (includes screen analysis) under 5s
            "tts": 4.0,        # TTS under 4s
            "total_pipeline": 10.0  # Total under 10s
        }
    ...
    def record_metric(self, service: str, operation: str, duration: float, 
    ...
    def optimize_automatically(self) -> Dict[str, Any]:
        ...
        if (stt_stats and tts_stats and 
            stt_stats.avg_duration > 2.0 and tts_stats.avg_duration > 2.0):
        ...
        if (tts_stats and tts_stats.total_requests > 10 and 
            tts_stats.avg_duration > 3.0):
...
class PerformanceTimer:
    ...
    def __init__(self, monitor: PerformanceMonitor, service: str, operation: str, metadata: Dict[str, Any] = None):
